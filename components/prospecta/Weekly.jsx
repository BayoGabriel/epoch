        ...
        <>
            <div id='newsletter' className="w-full max-lg:p-6 lg:p-[120px] flex flex-col items-center justify-center">
                ...
                <div className="w-full grid-cols-4 grid max-lg:grid-cols-1 gap-3">
                    {[...Array(4)].map((_, index) => (
                        <div key={index} className="flex flex-col flex-grow rncard rounded-[8px] border border-[#DCDEE1] p-0">
                            <Image src={fete} alt='image' className='w-full'/>
                            <div className="w-full flex flex-col flex-grow gap-[22px] px-4 pt-3 lg:px-6 lg:pt-4 pb-10">
                                <h4 className="h4 text-[#242424]">Opportunities for the week (14th September, 2024)</h4>
                                <p className="bt1 text-[#2E2E2E]">We have 36 opportunities this week, please pay attention to the deadlines.</p>
                                <div className="">
                                    <button className="border py-[6px] px-[15px] border-[#DCDEE1] rounded-[8px] rn">Read Now</button>
                                </div>
                            </div>
                        </div>
                    ))}
